...
#define MIC_SAMPLES	128
    ...
    uint8_t  text[30];
	  ...
	  /* Init OnboardMIC */
	  BSP_AUDIO_IN_OUT_Init(INPUT_DEVICE_DIGITAL_MICROPHONE_2, OUTPUT_DEVICE_BOTH, 100, I2S_AUDIOFREQ_48K);
    BSP_AUDIO_OUT_SetFrequency(I2S_AUDIOFREQ_48K);
      ...
      sprintf((char*)text, "Volume = %d", volume);
      BSP_LCD_DisplayStringAt(15, BSP_LCD_GetYSize() - 150, (uint8_t *)&text, LEFT_MODE);
